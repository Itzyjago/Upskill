...
- idea: is /count's response idempotency (http.md) worth a property-based test — same body in, same tally out, N random inputs — instead of just the fixed table-driven cases?
